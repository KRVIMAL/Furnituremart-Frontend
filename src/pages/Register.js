        ...
        <form className="col-md-6" method="post" action="/register" style={{marginTop:'20px'}}>
            ...
            <div className="row justify-content-center" style={{ marginTop: '10px' }}>
                <div className="col col-md-10">
                    <button type="submit" className="btn btn-primary signin" onClick={getInput} style={radiuscss}>Sign Up</button>
                </div>
            </div>
            <div className="Links">
                            <div className="row" style={{ textAlign: 'start', fontWeight: '600', padding: '10px' }}>
                                ...
                                <div className="col">
                                    <span>All ready have an account?</span><Link to="/login" style={{ color: '#5138EE' }}> Sign in</Link>
                                </div>
                            </div>
                        </div>
        </form>
