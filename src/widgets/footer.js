    ...
    <div className="container top-footer p-md-3 p-1">
      <div className="row">
        ...
        <div className="col-md-4 pl-4 pr-4">
          ...
          <ul className="navbar-nav mr-auto justify-content-around">
                <li className="nav-item active" >
                  <p className="nav-link" style={{ fontWeight: '700' }}><i className="fas fa-phone"></i> +(91) 123456789</p>
                </li>
                <li className="nav-item active" >
                  <p className="nav-link" style={{ fontWeight: '700' }}><i className="fas fa-envelope"></i> contact@Furnituremart.com </p>
                </li>
